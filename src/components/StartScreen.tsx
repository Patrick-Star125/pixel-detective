...
export function StartScreen({ title, subtitle, onStart }: StartScreenProps) {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-950 text-white font-sans">
      <h1 className="text-5xl font-bold mb-4 tracking-wider text-red-500 pixel-font drop-shadow-lg">{title}</h1>
      <p className="text-gray-400 mb-12 text-lg">{subtitle}</p>
