...
export function InteractionMenu({ object, onTalk, onInterrogate, onClose }: InteractionMenuProps) {
  return (
    <div className="fixed inset-0 z-40 flex items-center justify-center bg-black/40">
      <div className="bg-gray-800 border border-gray-600 rounded-lg shadow-xl p-6 min-w-[300px]">
        <div className="text-center mb-6">
          ...
          {object.type === 'NPC' && <p className="text-gray-400 text-sm mt-1">你想做什么？</p>}
        </div>
